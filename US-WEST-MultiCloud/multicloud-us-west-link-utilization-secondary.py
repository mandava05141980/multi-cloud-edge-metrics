...
def main():
    ...
    metric_data = []
    widget_ids = [13053, 13055, 13057, 13132]
    gateway_map = {
        13053: 'aws_gw_west-secondary',
        13055: 'azure_gw_west-secondary',
        13057: 'autodesk_gw_west-secondary',
        13132: 'cloud-fabric-sec_gw_west',
    }
    ...
    for widget_id in widget_ids:
        ...
        for metric in response.get("data", {}).get("rows", []):
            try:
                metric_json = {
                    "measurement": "multicloud_link_us-west-secondary",
                    "tags": {
                        "gateway": gateway
                    },
                    "fields": {
