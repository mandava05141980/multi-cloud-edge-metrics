...
def main():
    ...
    metric_data = []
    widget_ids = [13083, 13084]
    gateway_map = {
        13083: 'dc_cnhonpa01-equinix_gw_shanghai-percent',
        13084: 'dc_cnhonpa01-equinix_gw_shanghai-percent-sec',
    }
    ...
    for widget_id in widget_ids:
        ...
        for metric in response.get("data", {}).get("rows", []):
            try:
                metric_json = {
                    "measurement": "dc_link_hongkong-percent",
                    "tags": {
                        "gateway": gateway
                    },
                    "fields": {
