...
def main():
    ...
    metric_data = []
    widget_ids = [13062, 13064, 13066]
    gateway_map = {
        13062: 'aws_gw_east-percent-secondary',
        13064: 'azure_gw_east-percent-secondary',
        13066: 'autodesk_gw_east-percent-secondary'
    }
    ...
    for widget_id in widget_ids:
        ...
        for metric in response.get("data", {}).get("rows", []):
            try:
                metric_json = {
                    "measurement": "multicloud_link_us-east-percent-secondary",
                    "tags": {
                        "gateway": gateway
                    },
                    "fields": {
