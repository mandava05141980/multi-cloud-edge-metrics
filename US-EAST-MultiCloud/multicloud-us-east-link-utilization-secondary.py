...
def main():
    ...
    metric_data = []
    widget_ids = [13061, 13063, 13065]
    gateway_map = {
        13061: 'aws_gw_east-secondary',
        13063: 'azure_gw_east-secondary',
        13065: 'autodesk_gw_east-secondary'
    }
    ...
    for widget_id in widget_ids:
        ...
        for metric in response.get("data", {}).get("rows", []):
            try:
                metric_json = {
                    "measurement": "multicloud_link_us-east-secondary",
                    "tags": {
                        "gateway": gateway
                    },
                    "fields": {
