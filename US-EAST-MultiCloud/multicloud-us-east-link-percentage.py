...
def main():
    ...
    metric_data = []
    widget_ids = [12902, 12904, 12906]
    gateway_map = {
        12902: 'aws_gw_east-percent',
        12904: 'azure_gw_east-percent',
        12906: 'autodesk_gw_east-percent'
    }
    ...
    for widget_id in widget_ids:
        ...
        for metric in response.get("data", {}).get("rows", []):
            try:
                metric_json = {
                    "measurement": "multicloud_link_us-east-percent",
                    "tags": {
                        "gateway": gateway
                    },
                    "fields": {
